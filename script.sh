...
sudo apt update && sudo apt upgrade -y && sudo apt install gobuster feroxbuster pipx neofetch lolcat apt-transport-https bloodhound seclists socat kali-wallpapers-all bat golang-go -y
