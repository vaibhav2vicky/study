...
[/home/kali/study/OSCP/Labs/10.11.1.223/results/10.11.1.223/scans/_quick_tcp_nmap.txt](file:///home/kali/study/OSCP/Labs/10.11.1.223/results/10.11.1.223/scans/_quick_tcp_nmap.txt):

```
# Nmap 7.92 scan initiated Mon Aug 22 22:48:54 2022 as: nmap -vv --reason -Pn -T4 -sV -sC --version-all -A --osscan-guess -oN /home/kali/study/OSCP/Labs/10.11.1.223/results/10.11.1.223/scans/_quick_tcp_nmap.txt -oX /home/kali/study/OSCP/Labs/10.11.1.223/results/10.11.1.223/scans/xml/_quick_tcp_nmap.xml 10.11.1.223
adjust_timeouts2: packet supposedly had rtt of -79221 microseconds.  Ignoring time.
adjust_timeouts2: packet supposedly had rtt of -79221 microseconds.  Ignoring time.
Nmap scan report for 10.11.1.223
Host is up, received user-set (0.15s latency).
Scanned at 2022-08-22 22:48:55 EDT for 107s
...
|_ssl-date: 2022-08-23T02:50:39+00:00; -1s from scanner time.
...
|_  System_Time: 2022-08-23T02:50:31+00:00
Device type: general purpose
Running (JUST GUESSING): Microsoft Windows 2012|2016|7|Vista|2008|XP (87%)
OS CPE: cpe:/o:microsoft:windows_server_2012 cpe:/o:microsoft:windows_server_2016 cpe:/o:microsoft:windows_7 cpe:/o:microsoft:windows_vista::sp1:home_premium cpe:/o:microsoft:windows_server_2008::sp1 cpe:/o:microsoft:windows_server_2008:r2 cpe:/o:microsoft:windows_xp::sp3
Aggressive OS guesses: Microsoft Windows Server 2012 (87%), Microsoft Windows Server 2012 or Windows Server 2012 R2 (87%), Microsoft Windows Server 2012 R2 (87%), Microsoft Windows Server 2016 (87%), Microsoft Windows 7 (87%), Microsoft Windows Vista Home Premium SP1 (86%), Microsoft Windows Server 2008 SP1 or Windows Server 2008 R2 (86%), Microsoft Windows XP SP3 (85%)
No exact OS matches for host (If you know what OS is running on it, see https://nmap.org/submit/ ).
TCP/IP fingerprint:
OS:SCAN(V=7.92%E=4%D=8/22%OT=21%CT=1%CU=37825%PV=Y%DS=2%DC=T%G=Y%TM=6304408
OS:2%P=x86_64-pc-linux-gnu)SEQ(SP=104%GCD=1%ISR=10E%TI=I%TS=U)SEQ(SP=104%GC
OS:D=1%ISR=10E%TS=U)OPS(O1=M54ENW8NNS%O2=M54ENW8NNS%O3=M54ENW8%O4=M54ENW8NN
OS:S%O5=M54ENW8NNS%O6=M54ENNS)WIN(W1=FFFF%W2=FFFF%W3=FFFF%W4=FFFF%W5=FFFF%W
OS:6=FF70)ECN(R=Y%DF=Y%T=80%W=FFFF%O=M54ENW8NNS%CC=Y%Q=)T1(R=Y%DF=Y%T=80%S=
OS:O%A=S+%F=AS%RD=0%Q=)T2(R=N)T3(R=N)T4(R=N)T5(R=Y%DF=Y%T=80%W=0%S=Z%A=S+%F
...
|   Check 3 (port 34774/udp): CLEAN (Timeout)
|   Check 4 (port 34185/udp): CLEAN (Timeout)
|_  0/4 checks are positive: Host is CLEAN or ports are blocked
| smb2-time: 
|   date: 2022-08-23T02:50:30
|_  start_date: N/A
| smb2-security-mode: 
|   3.1.1: 
...
HOP RTT       ADDRESS
1   153.42 ms 192.168.119.1
2   153.52 ms 10.11.1.223

Read data files from: /usr/bin/../share/nmap
OS and Service detection performed. Please report any incorrect results at https://nmap.org/submit/ .
# Nmap done at Mon Aug 22 22:50:42 2022 -- 1 IP address (1 host up) scanned in 108.22 seconds
